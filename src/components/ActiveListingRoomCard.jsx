        ...
        >
          ...
          <View className="items-end justify-center">
            ...
            <View className="flex-row items-baseline">
              <ThemedText styles="text-md font-Bold">
                {item?.currency} {item?.hotelRoomPriceNight}
              </ThemedText>
...
export default ActiveListingRoomCard;
