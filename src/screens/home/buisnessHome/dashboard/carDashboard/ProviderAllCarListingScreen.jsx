...
// import ActiveListingRoomCard from '@/components/ActiveListingRoomCard';
import { useGetProviderCarListingQuery } from '@/redux/slices/providerSlice/carSlice';
import ActiveListingCarListingCard from '@/components/ActiveListingCarListingCard';

const ProviderAllCarListingScreen = ({ route }) => {
  ...
  //   console.log('LINE AT 44', hotelsData);
    ...
    >
      <View className="flex-row justify-between items-center">
        <View className="flex-row gap-8 items-center">
          ...
          <ThemedText styles="text-lg font-SemiBold">All Cars</ThemedText>
        </View>
        <Pressable
          onPress={() =>
            navigation.navigate('Dashboard', {
              screen: 'ProviderAddCarListing',
            })
          }
      ...
      <FlatList
        data={allHotels}
        renderItem={({ item }) => (
          <ActiveListingCarListingCard
            key={item.id}
            item={item}
            name={'selectedActiveListingCar'}
            navigation={navigation}
            path="Dashboard"
            screen="ProviderEditCarListing"
            // pathListing="ProviderEditCarListing"
          />
        )}
        ...
        ListEmptyComponent={
          hotelsLoading ? (
            ...
            <View style={{ alignItems: 'center', marginTop: 40 }}>
              <ThemedText>No car found.</ThemedText>
            </View>
          )
        }
...
export default ProviderAllCarListingScreen;
