...
import { useGetProviderAttractionListingQuery } from '@/redux/slices/providerSlice/attractionSlice';
import ActiveAttractionListingCard from '@/components/ActiveAttractionListingCard';

const ProviderAttractionDashboardAllListingScreen = ({ route }) => {
  ...
  return (
    ...
    >
        ...
        <Pressable
          onPress={() =>
            navigation.navigate('Dashboard', {
              screen: 'ProviderAttractionAddListing',
            })
          }
      ...
      <FlatList
        data={allHotels}
        renderItem={({ item }) => (
          <ActiveAttractionListingCard
            key={item.id}
            item={item}
            name={'selectedActiveListingAttractionAppeal'}
            navigation={navigation}
            path="Dashboard"
            screen="ProviderAttractionEditListing"
          />
        )}
...
export default ProviderAttractionDashboardAllListingScreen;
